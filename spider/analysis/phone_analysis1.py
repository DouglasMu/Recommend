...
with open('F:\\PythonFile\\Recommend\\spider\\analysis\\feature.txt') as f:
    features = list(f.read().split())


def features_analysis(file_name):
    file_path = "F:\\data\\phone\\" + file_name
    mingci = ['n', 'ng', 'nz', 'nl']
...
def get_result():
    file_list = os.listdir("F:\\data\\phone")
    result = {}
...
if __name__ == '__main__':
    dic = get_result()
    print(dic)
    with open("F:\\PythonFile\\Recommend\\app\\spider\\data\\feat.txt",'w') as f:
        f.write(str(dic))
